...
import hris from "../assets/hris-app.jpg";
import Schedule from "../assets/schedule.jpeg";
import DMS from "../assets/dms.jpeg";
...
function Projects() {
  const [projects] = useState([
    ...
    {
      image: hris, // replace with actual image
      name: "HRIS System",
      brief:
        "Comprehensive Human Resource Information System with employee data, attendance, and performance modules.",
    },
    {
      image: Schedule, // replace with actual image
      name: "Schedule App",
      brief: "Customer will book and get Appointment any field",
    },
    {
      image: DMS, // replace with actual image
      name: "CFlash DMS",
      brief:
        "Document management solution for archiving, retrieving, and sharing business documents securely.",
    },
    {
      image: Ticket, // replace with actual image
      name: "Ticket Raising System",
      brief:
        "Internal support system to raise, track, and resolve IT-related issues efficiently.",
    },
  ]);
  return (
    <section
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="flex flex-wrap sm:items-center gap-2 mb-4">
                  {["React", ".NET WebApi", "MSSQL", "Azure"].map(
                    (tech, index) => (
                      <span
                        key={index}
                  ...
                  <div className="flex flex-col text-center my-5 py-3 justify-center gap-3 border-2 border-white/10 hover:border-blue-500/30 hover:shadow-[9_2px_8px_rgba(59,130,22.46,0.2)]  cursor-pointer rounded-xl ">
                    ...
                    <a
                      href="https://github.com/athas-SWE"
